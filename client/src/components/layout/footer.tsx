      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <h3 className="text-primary dark:text-white text-xl font-bold">Stylease</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Your one-stop destination for fashion and style. Discover the latest trends and express yourself through fashion.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link href="/products?category=jeans">
                  <a className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
                    Jeans
                  </a>
                </Link>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8">
          <p className="text-sm text-gray-400 text-center">
            &copy; {new Date().getFullYear()} Stylease. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
